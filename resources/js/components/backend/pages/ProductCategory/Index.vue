...
export default {
    ...
    created(){
        this.generalApi = "product-category"
        this.cardTitle ="Product Category"
        this.columnsHead.push('Sn','Category Name', 'Cat Image', 'Status', 'Action')
      
        this.columnsBody.push('category_name','image_path', 'status')
